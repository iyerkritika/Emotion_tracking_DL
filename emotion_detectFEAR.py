...
def load_data():
	...
	immatrix,label= pickle.load(open('databaseFEAR.pickle','rb'),encoding='latin1')
	print ("Number of input samples:", len(label))
	print ("images:",immatrix.shape)

	immatrix=np.reshape(immatrix,(30000,1,48,48))
...
with open("modelFEAR.json", "w") as json_file:
