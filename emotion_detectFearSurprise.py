...
def load_data():
	...
	immatrix,label= pickle.load(open('databaseFearSurprise.pickle','rb'),encoding='latin1')
	print ("Number of input samples:", len(label))
	print ("images:",immatrix.shape)

	immatrix=np.reshape(immatrix,(24000,1,48,48))
...
with open("modelFearSurprise.json", "w") as json_file:
    json_file.write(model_json)

model.save_weights("modelFearSurprise.h5")
